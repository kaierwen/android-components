package github.kaierwen.android.components.debug.beagle
...
import github.kaierwen.android.components.BuildConfig
...
class MyBeagle {
    ...
    fun init(app: Application) {
        init(app, BuildConfig.DEBUG_BUILD_DATE)
    }
    ...
    fun init(app: Application, buildTime: String) {
        ...
        if (buildTime.isNotEmpty()) {
            appInfo.append(app.resources.getString(R.string.debug_built_time)).append(" -> ")
                .append(buildTime).append(" ")
                .append(app.resources.getString(R.string.debug_built_time_beijing)).append("\n")
        }
        appInfo.append(app.resources.getString(R.string.debug_package)).append(" -> ")
            .append(app.packageName).append("\n")
            .append(app.resources.getString(R.string.debug_version_name)).append(" -> v")
            .append(packageInfo.versionName).append("\n")
            .append(app.resources.getString(R.string.debug_version_code))
            .append(" -> ").append(packageInfo.versionCode)

        Beagle.learn(
            listOf(
                Trick.Header(
                    title = app.resources.getString(R.string.debug_app_name),
                    text = appInfo.toString()
                ),
                Trick.AppInfoButton(app.resources.getString(R.string.debug_app_info)),
                Trick.ScreenshotButton(app.resources.getString(R.string.debug_screen_shot)),
                Trick.ForceCrashButton(app.resources.getString(R.string.debug_force_crash)),
                Trick.KeylineOverlayToggle(
                    app.resources.getString(R.string.debug_show_grid),
                    gridColor = Color.BLUE
                ),
                Trick.ViewBoundsOverlayToggle(
                    app.resources.getString(R.string.debug_show_bounds),
                    color = Color.CYAN
                ),
                Trick.DeviceInformationKeyValue(app.resources.getString(R.string.debug_device_info))
            )
        )
    }
